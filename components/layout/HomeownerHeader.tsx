...
export const HomeownerHeader = () => {
    ...
    return (
        <>
            <header className="fixed top-0 right-0 left-0 lg:left-64 h-16 z-40 bg-white/80 backdrop-blur-md border-b border-border flex items-center justify-end px-6 gap-3">
                {/* Notification Bell */}
                <button
